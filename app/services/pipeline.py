...
from app.services.transcribe.downloader import download_video
from app.services.transcribe.transformer import convert_to_wav
from app.services.transcribe.transcriber import transcribe_audio
...
def execute(url: str, language: str) -> dict:
    ...
    try:
        ...
        return analyze_text(texts, language)
